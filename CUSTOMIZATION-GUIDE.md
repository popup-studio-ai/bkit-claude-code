...
> **v1.5.6**: Claude Code Exclusive with CTO-Led Agent Teams (16 agents), Plan Plus skill (brainstorming-enhanced planning), bkend MCP Accuracy Fix (28+ tools), Output Styles, Agent Memory, and Team Visibility
...
### bkit Plugin Structure Example (v1.5.6 - Claude Code Exclusive)
