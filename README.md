...
[![Version](https://img.shields.io/badge/Version-2.0.5-green.svg)](CHANGELOG.md)
...
- **Agent Memory (v1.5.1)** - Cross-session context persistence for all 31 agents (auto-active)
