...
const CC_REGRESSIONS = [
  ...
  },
  {
    ...
    resolvedAt: null,
    notes: "context:fork × disable-model-invocation regression (Windows). One of bkit's 8 context:fork producer skills (v2.1.31: each added background:false to opt out of CC v2.1.218 fork background-by-default; qa-phase left the fork set — AskUserQuestion is stripped at the fork boundary, CC #34592/#54892).",
  },
