...
const PRICING_PER_MTOK = Object.freeze({
  // Published Claude API list prices — caller can override via opts.pricing
  'sonnet':  { input: 3.0,   output: 15.0  }, // Sonnet 4.x / Sonnet 5 list price
  'opus':    { input: 5.0,   output: 25.0  }, // Opus 4.8
  'haiku':   { input: 1.0,   output: 5.0   }, // Haiku 4.5
  'fable':   { input: 10.0,  output: 50.0  }, // Fable 5
  'unknown': { input: 3.0,   output: 15.0  }, // Default Sonnet-class fallback
});
