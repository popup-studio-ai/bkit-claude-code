 ...
 *
 * Design Ref: ENH-170 — CC v2.1.87 worktree isolation
 * AgentTool supports { isolation: "worktree" } for git-based isolation.
 * When multiple agents write to same project in swarm pattern,
 * consider worktree isolation to prevent file conflicts.
 * CC creates temporary git worktree and auto-cleans if no changes.
 * Apply to swarm pattern spawns when agents modify overlapping files.
 */
