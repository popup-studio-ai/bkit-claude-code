 ...
 * Kept in sync with README (conservative runtime recommendation) and at/above
 * the hard install floor (v2.1.143, strict plugin-manifest `displayName`).
 * Updated alongside Sprint cadence — see MEMORY.md "consecutive compatible".
 */
const RECOMMENDED_VERSION = '2.1.150';
