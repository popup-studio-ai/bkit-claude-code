 ...
 * 2.1.197; the recommendation is bumped to 2.1.218, the release whose
 * `context: fork` background-by-default change bkit explicitly handles (8
 * producer skills opt out via `background: false`; qa-phase left the fork set).
 ...
 */
const RECOMMENDED_VERSION = '2.1.218';
