 ...
 * @property {(sprint: object) => number} [compute] - For gateType='computed'
 *           gates: pure function deriving the numeric value from sprint state.
 */
...
const UNSUPPORTED_GATES = Object.freeze([
  ...
  'S4',  // archiveReadiness — boolean preflight (Slice 2)
]);
