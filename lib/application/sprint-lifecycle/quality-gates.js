 ...
 *   - S2 (featureCompletion): unrouted until Slice 3, so its slot default
 *     ({current:0, passed:false}) would make S4 permanently false. S2 ships
 *     in Slice 3; until then it is not a measurable gate. Excluding it keeps
 *     S4 achievable, which is the point of the "no gate in limbo" guarantee.
 *
 * Single SoT: docs/01-plan/features/v2116-issue-fixes.master-plan.md §11.3 AC4
 * (S2 carried to v2.1.17 / Slice 3).
 */
