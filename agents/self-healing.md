...
- Integrated with /deploy skill (v2.1.13): when auto-fix exhausts its
  5-iteration budget or a critical invariant is violated, escalates to
  /pdca deploy rollback as final remediation.
