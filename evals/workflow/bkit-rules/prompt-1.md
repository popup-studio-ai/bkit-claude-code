...
Context: The project has no existing CLAUDE.md level declaration,
contains a src/ folder with components/ and lib/ directories,
and has no infra/terraform/ or services/ folder.
