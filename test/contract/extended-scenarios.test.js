...
test('EXPECTED_COUNTS.hookEvents = 22', () => assert.strictEqual(invariants.EXPECTED_COUNTS.hookEvents, 22));
test('EXPECTED_COUNTS.hookBlocks = 25', () => assert.strictEqual(invariants.EXPECTED_COUNTS.hookBlocks, 25));
